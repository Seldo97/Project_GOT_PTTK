...
//    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/turysta/mojeKonto","/turysci/updateForm","/turysci/updateForm","/turysci/update/{idTurysta}","/zdjecia/{idWycieczka}","/zdjecia/form/{idWycieczka}","/zdjecie/dodaj/{idWycieczka}","/zdjecie/usun/{idWycieczka}").hasAnyRole("administrator", "turysta")
